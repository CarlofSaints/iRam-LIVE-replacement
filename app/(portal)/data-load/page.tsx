        ...
        <div className="mb-6 flex items-start gap-3 rounded-xl border border-amber-300 bg-amber-50 px-4 py-3">
          ...
          <div className="text-sm text-amber-800">
            ...
            <p className="mt-0.5 leading-relaxed">
              {/* `lockMessage` already explains one-at-a-time and says to try
                  again shortly, so repeating it here just said the same thing
                  twice in one paragraph. Add only what it does NOT say. */}
              {lockHolder.message || `${lockHolder.userName} is loading a DISPO.`}{" "}
              You can set everything up while you wait.
            </p>
          </div>
        </div>
      )}
