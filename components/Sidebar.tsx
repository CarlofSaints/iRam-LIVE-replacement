...
const controlCentreNav: NavItem[] = [
  ...
  {
    label: "Dropbox",
    href: "/control-centre/dropbox",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polygon points="12 2 6 6 12 10 18 6 12 2" /><polygon points="6 6 0 10 6 14 12 10 6 6" /><polygon points="18 6 12 10 18 14 24 10 18 6" /><polygon points="6 14 12 10 18 14 12 18 6 14" /><polyline points="6 18 12 22 18 18" /></svg>
    ),
  },
  {
    label: "Data Health",
...
export default function Sidebar() {
  ...
  const navPermission: Record<string, string> = {
    ...
    // Same permission the probe / connect / self-test routes enforce, so the
    // link cannot show for someone who would only get a 403.
    "/control-centre/dropbox": "view_sql_pilot",
    ...
    // Same permission /api/reports/portfolio-health enforces.
